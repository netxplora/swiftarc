  ...
  "inline-flex h-[24px] items-center rounded-[4px] border px-2 text-[11px] font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-primary",
  {
    variants: {
      variant: {
        ...
        outline: "border-border bg-transparent text-foreground dark:border-white/20 dark:text-white",
        success: "border-success/30 bg-success/15 text-success dark:bg-success/25 dark:text-green-300",
        warning: "border-warning/30 bg-warning/15 text-warning dark:bg-warning/25 dark:text-amber-300",
