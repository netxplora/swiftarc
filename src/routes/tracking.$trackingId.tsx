  ...
  return (
    <>
      <AnimatePresence>
        {showFlashScreen && (
          <TrackingFlashScreen
            trackingCode={shipment.trackingNumber || trackingId}
            minDurationMs={1400}
            onFinish={() => setShowFlashScreen(false)}
          />
        )}
      </AnimatePresence>
        ...
        <div id="print-waybill" className="hidden print:block">
          ...
          <div className="waybill-grid">
            ...
            <div className="waybill-section">
              ...
              {shipment.destination.phone && (
                <p className="sub">Tel: {shipment.destination.phone}</p>
              )}
          ...
          <div className="waybill-footer">
            <div className="disclaimer">
              This document is an official shipment record issued by SwiftArc Logistics. Please
              retain this document for your records. For queries, contact support@swiftarc.com
            </div>
