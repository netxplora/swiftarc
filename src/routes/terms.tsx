      ...
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
          ...
          <p>
            ...
            any country in the world of applications, websites, content, products, and services made
            available by SwiftArc Global Logistics.
          </p>
          <h3>2. The Services</h3>
          <p>
            The Services constitute a technology platform that enables users of SwiftArc's mobile
            applications or websites provided as part of the Services to arrange and schedule
            transportation and/or logistics services with independent third party providers of such
            services.
          </p>
          <h3>3. Your Use of the Services</h3>
          <p>
            In order to use most aspects of the Services, you must register for and maintain an
            active personal user Services account ("Account"). You must be at least 18 years of age
          ...
          <p>
            ...
            services or goods obtained through your use of the Service, SwiftArc will facilitate
            your payment of the applicable Charges.
          </p>
        </div>
      </section>
    </>
