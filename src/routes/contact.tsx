...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Get in touch with SwiftArc's enterprise sales team or global support network.",
      },
...
function Contact() {
  ...
  const offices = [
    ...
    },
    {
      ...
      address: "One World Trade Center, Suite 4500, NY 10007",
        ...
        <div className="grid gap-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-muted-foreground max-w-md">
              Whether you need to architect a complex cold-chain route or integrate your e-commerce
              platform via our API, our specialists are ready to architect your solution.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-10 space-y-6">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-navy-deep text-cream hover:bg-navy"
              >
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Operating across 3 major hubs to ensure 24/7 coverage.
              </p>
            </div>
            ...
            <div className="grid gap-6">
              {offices.map((office) => (
                <Card
                  key={office.city}
                  className="overflow-hidden border-border transition-colors hover:border-amber/50"
                >
            ...
            <div className="rounded-2xl bg-navy-deep p-8 text-cream">
              ...
              <p className="mt-3 text-sm text-cream/70">
                Existing customers receive 24/7 priority routing support. Please log in to your
                dashboard to access live chat or call your dedicated account manager.
              </p>
