      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{totalCount}</span> total Â·{" "}
            <span className="font-medium text-amber">{adminCount}</span> admin
            {adminCount !== 1 ? "s" : ""}.
          </p>
        </div>
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <Input
              placeholder="Search name, email, or IDâ€¦"
              value={search}
