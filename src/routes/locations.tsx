...
import { MapPin, Clock, Phone, Search, Building2, Globe2, ArrowRight, CheckCircle2, Globe } from "lucide-react";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Branch Locations — SwiftArc Logistics" },
      {
        ...
        content: "Locate your nearest SwiftArc office for package drop-off, physical weighing, and shipment processing.",
      },
      { name: "keywords", content: "swiftarc locations, courier drop off, shipping office, freight terminal, parcel branches" },
    ],
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-14 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                Locate your nearest courier office for package drop-off, physical weighing, and shipping support — or discover our commercial freight hubs.
              </motion.p>
              ...
              >
                <div className="flex items-center gap-2 text-sm text-slate-500 bg-white/70 backdrop-blur-sm border border-slate-200 rounded-full px-4 py-1.5 font-medium">
                  <Building2 className="h-4 w-4 text-primary" /> {centers.length} facilities globally
                </div>
                <div className="flex items-center gap-2 text-sm text-slate-500 bg-white/70 backdrop-blur-sm border border-slate-200 rounded-full px-4 py-1.5 font-medium">
            ...
            <div className="hidden lg:col-span-5 lg:block">
              ...
              >
                <div className="relative overflow-hidden rounded-3xl border border-white/70 bg-white/25 backdrop-blur-md p-2 shadow-2xl shadow-[#032D60]/12">
                  <img src={heroImg} alt="SwiftArc Global Locations" className="w-full h-72 sm:h-80 rounded-2xl object-cover" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-2 text-sm text-foreground">
            ...
            <span className="text-muted-foreground">
              Please visit any of our Courier Offices listed below to send a package. Our team will weigh, measure, and process your shipment on-site.
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {filtered.length === 0 ? (
            <div className="rounded-3xl border border-slate-100 bg-white p-12 text-center shadow-sm">
              ...
              <Button
                onClick={() => { setQ(""); setSelectedType("All"); }}
                variant="outline"
                ...
                <StaggerItem key={c.name}>
                  <div className="group h-full flex flex-col justify-between rounded-2xl border border-slate-100 bg-white p-6 shadow-sm hover:shadow-xl hover:-translate-y-1.5 hover:border-primary/15 transition-all duration-400">
                    <div>
                      ...
                      <h3 className="font-display font-bold text-[#032D60] text-lg mb-1 group-hover:text-primary transition-colors">{c.name}</h3>
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-[#032D60] uppercase tracking-wider mb-2.5">Available Services</p>
                      <div className="flex flex-wrap gap-2">
                        {c.services.map((svc) => (
                          <span
                            key={svc}
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          <FadeInSection className="space-y-6">
            ...
            <p className="text-white/75 max-w-xl mx-auto leading-relaxed">
              Contact our central coordination team for customized quotes, dangerous goods transport, or bulk container bookings.
            </p>
