...
export const Route = createFileRoute("/locations")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Find SwiftArc drop-off points, service centers, and air gateways worldwide.",
      },
      { property: "og:title", content: "Locations — SwiftArc" },
      {
        property: "og:description",
        content: "Global network of drop-off points and service centers.",
      },
...
const centers: Array<{
  ...
  {
    name: "Rotterdam Origin Hub",
    type: "Air Gateway",
    addr: "Waalhaven Z.z. 32, Rotterdam",
    hours: "24 / 7",
  ...
  },
  {
    ...
    type: "Distribution",
    addr: "Via Ripamonti 200, Milan",
    hours: "Mon–Sat · 06:00–22:00",
    phone: "+39 02 555 0110",
    open: true,
  },
  {
    name: "Frankfurt Air Gateway",
    type: "Air Gateway",
    addr: "Cargo City Süd, Frankfurt Airport",
    hours: "24 / 7",
    phone: "+49 69 555 0120",
    open: true,
  },
  {
    name: "Austin Origin Hub",
    type: "Sort Center",
    addr: "5000 Burnet Rd, Austin, TX",
    hours: "Mon–Fri · 05:00–23:00",
  ...
  },
  {
    ...
    type: "Distribution",
    addr: "7500 E 41st Ave, Denver, CO",
    hours: "Mon–Sun · 07:00–21:00",
    phone: "+1 303 555 0150",
    open: true,
  },
  {
    name: "Camden Drop-off",
    type: "Drop-off",
    addr: "220 Camden High St, London",
    hours: "Mon–Sat · 08:00–20:00",
    phone: "+44 20 5555 0160",
    open: false,
  },
  {
    name: "Shibuya Drop-off",
    type: "Drop-off",
    addr: "1-2 Dogenzaka, Tokyo",
            ...
            {filtered.map((c, i) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`inline-flex items-center gap-1 text-[10px] font-semibold uppercase tracking-widest ${c.open ? "text-success" : "text-muted-foreground"}`}
                  >
                    <span
                      className={`h-1.5 w-1.5 rounded-full ${c.open ? "bg-success" : "bg-muted-foreground"}`}
                    />
                    {c.open ? "Open now" : "Closed"}
                  </span>
                </div>
                <h3 className="mt-3 font-display text-lg group-hover:text-amber transition-colors">
                  {c.name}
                </h3>
